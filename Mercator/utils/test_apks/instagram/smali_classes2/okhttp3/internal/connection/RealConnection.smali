...
.field public sink:Lc/d;

.field public socket:Ljava/net/Socket;

.field public source:Lc/e;
...
.method private buildTunneledConnection(IIILokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 163
    iput-object v5, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/d;

    .line 164
    iput-object v5, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/e;
...
.method private connectSocket(II)V
    ...
    iput-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/e;
    ...
    iput-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/d;
...
.method private connectTls(IILokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    iput-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/e;
    ...
    iput-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/d;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/e;

    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/d;

    invoke-direct {v4, v2, v2, v0, v1}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lc/e;Lc/d;)V
    ...
    invoke-virtual {v0, v6, v7, v1}, Lc/t;->timeout(JLjava/util/concurrent/TimeUnit;)Lc/t;

    .line 294
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/d;
    ...
    .line 297
    invoke-virtual {v4}, Lokhttp3/internal/http1/Http1Codec;->readResponse()Lokhttp3/Response$Builder;
    ...
    .line 304
    :cond_1
    invoke-virtual {v4, v0, v1}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lc/s;
    ...
    invoke-static {v0, v1, v4}, Lokhttp3/internal/Util;->skipAll(Lc/s;ILjava/util/concurrent/TimeUnit;)Z
...
.method private establishProtocol(IILokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/e;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/d;

    invoke-virtual {v0, v1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lc/e;Lc/d;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIILjava/util/List;Z)V
    ...
    .line 121
    iput-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/e;

    .line 122
    iput-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/d;
...
.method public isHealthy(Z)Z
    ...
    .line 377
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/e;
