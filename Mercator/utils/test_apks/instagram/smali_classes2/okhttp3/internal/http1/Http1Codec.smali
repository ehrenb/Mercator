...
.field final sink:Lc/d;

.field final source:Lc/e;
...
# direct methods
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lc/e;Lc/d;)V
    .locals 1
    ...
    .line 91
    iput-object p3, p0, Lokhttp3/internal/http1/Http1Codec;->source:Lc/e;

    .line 92
    iput-object p4, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lc/d;

    .line 93
    return-void
.end method

.method private getTransferStream(Lokhttp3/Response;)Lc/s;
    .locals 4
    ...
    invoke-virtual {p0, v0, v1}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lc/s;
    ...
    invoke-virtual {p0, v0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSource(Lokhttp3/HttpUrl;)Lc/s;
    ...
    .line 157
    :cond_2
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newUnknownLengthSource()Lc/s;
...
.method public createRequestBody(Lokhttp3/Request;J)Lc/r;
    ...
    .line 98
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSink()Lc/r;
    ...
    .line 103
    invoke-virtual {p0, p2, p3}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSink(J)Lc/r;
...
.method public finishRequest()V
    ...
    .prologue
    .line 166
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lc/d;
...
.method public newChunkedSink()Lc/r;
    .locals 3
...
.method public newChunkedSource(Lokhttp3/HttpUrl;)Lc/s;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newFixedLengthSink(J)Lc/r;
    .locals 3
...
.method public newFixedLengthSource(J)Lc/s;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newUnknownLengthSource()Lc/s;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    .prologue
    .line 136
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1Codec;->getTransferStream(Lokhttp3/Response;)Lc/s;
...
.method public readHeaders()Lokhttp3/Headers;
    ...
    .line 216
    :goto_0
    iget-object v1, p0, Lokhttp3/internal/http1/Http1Codec;->source:Lc/e;
...
.method public readResponse()Lokhttp3/Response$Builder;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->source:Lc/e;
...
.method public writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    .line 174
    iget-object v2, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lc/d;
