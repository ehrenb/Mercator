...
.field private final source:Lc/e;
...
.method public constructor <init>(Lc/e;Z)V
    ...
    .line 71
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/e;
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/e;

    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lc/e;)V
    ...
    invoke-direct {v0, v1, v2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILc/s;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/e;

    invoke-interface {v0}, Lc/e;->i()B
    ...
    .line 203
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/e;

    invoke-interface {p1, v2, p4, v3, v1}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILc/e;I)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v0, v4, v5}, Lc/e;->d(J)Lc/f;

    move-result-object v0

    .line 319
    :cond_3
    invoke-interface {p1, v1, v3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lc/f;)V
...
.method static readMedium(Lc/e;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 298
    :cond_1
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/e;

    invoke-interface {v2}, Lc/e;->k()I
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v0}, Lc/e;->j()S

    move-result v0

    .line 247
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/e;

    invoke-interface {v4}, Lc/e;->k()I
...
.method public nextFrame(Lokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v2}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Lc/e;)I
    ...
    invoke-static {v0, v4, v2, v1, v3}, Lokhttp3/internal/http2/Http2;->frameLog(ZIIBB)Ljava/lang/String;
    ...
    .line 116
    :pswitch_0
    invoke-direct {p0, p1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Reader;->readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 120
    :pswitch_1
    invoke-direct {p0, p1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Reader;->readHeaders(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 124
    :pswitch_2
    invoke-direct {p0, p1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Reader;->readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 128
    :pswitch_3
    invoke-direct {p0, p1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Reader;->readRstStream(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 132
    :pswitch_4
    invoke-direct {p0, p1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Reader;->readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 136
    :pswitch_5
    invoke-direct {p0, p1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Reader;->readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 140
    :pswitch_6
    invoke-direct {p0, p1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Reader;->readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 144
    :pswitch_7
    invoke-direct {p0, p1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Reader;->readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 148
    :pswitch_8
    invoke-direct {p0, p1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Reader;->readWindowUpdate(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
...
.method public readConnectionPreface()V
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lc/f;
    ...
    invoke-interface {v0, v2, v3}, Lc/e;->d(J)Lc/f;
