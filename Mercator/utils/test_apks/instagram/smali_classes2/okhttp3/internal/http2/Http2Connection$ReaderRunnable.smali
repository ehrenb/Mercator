...
.method public alternateService(ILjava/lang/String;Lc/f;Ljava/lang/String;IJ)V
    .locals 0
...
.method public data(ZILc/e;I)V
    ...
    invoke-virtual {v0, p2, p3, p4, p1}, Lokhttp3/internal/http2/Http2Connection;->pushDataLater(ILc/e;IZ)V
    ...
    invoke-interface {p3, v0, v1}, Lc/e;->h(J)V

    goto :goto_0

    .line 596
    :cond_2
    invoke-virtual {v0, p3, p4}, Lokhttp3/internal/http2/Http2Stream;->receiveData(Lc/e;I)V
...
.method protected execute()V
    ...
    iget-boolean v1, v1, Lokhttp3/internal/http2/Http2Connection;->client:Z
    ...
    invoke-virtual {v1}, Lokhttp3/internal/http2/Http2Reader;->readConnectionPreface()V

    .line 568
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Connection$ReaderRunnable;->reader:Lokhttp3/internal/http2/Http2Reader;

    invoke-virtual {v1, p0}, Lokhttp3/internal/http2/Http2Reader;->nextFrame(Lokhttp3/internal/http2/Http2Reader$Handler;)Z
...
.method public goAway(ILokhttp3/internal/http2/ErrorCode;Lc/f;)V
    .locals 5
