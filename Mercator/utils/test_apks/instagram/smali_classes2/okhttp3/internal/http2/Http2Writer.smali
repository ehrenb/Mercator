...
.field private final hpackBuffer:Lc/c;

.field final hpackWriter:Lokhttp3/internal/http2/Hpack$Writer;

.field private maxFrameSize:I

.field private final sink:Lc/d;
...
.method public constructor <init>(Lc/d;Z)V
    .locals 2
    ...
    .line 58
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lc/d;
    ...
    iput-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lc/c;

    .line 61
    new-instance v0, Lokhttp3/internal/http2/Hpack$Writer;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lc/c;

    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(Lc/c;)V
...
.method private writeContinuationFrames(IJ)V
    ...
    .line 293
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lc/d;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lc/c;

    int-to-long v4, v1

    invoke-interface {v0, v2, v4, v5}, Lc/d;->write(Lc/c;J)V
...
.method private static writeMedium(Lc/d;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public declared-synchronized connectionPreface()V
    ...
    sget-object v4, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lc/f;

    invoke-virtual {v4}, Lc/f;->f()Ljava/lang/String;
...
.method public declared-synchronized data(ZILc/c;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IBLc/c;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method dataFrame(IBLc/c;I)V
    ...
    invoke-interface {v0, p3, v2, v3}, Lc/d;->write(Lc/c;J)V
...
.method public frameHeader(IIBB)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/http2/Http2Writer;->writeMedium(Lc/d;I)V
...
.method headers(ZILjava/util/List;)V
    ...
    .line 301
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lc/c;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lc/c;

    int-to-long v6, v1

    invoke-interface {v0, v4, v6, v7}, Lc/d;->write(Lc/c;J)V
...
.method public declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 200
    :goto_2
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lc/d;
