...
.method public constructor <init>(Lc/s;)V
    ...
    .line 542
    invoke-interface {v6}, Lc/e;->s()Ljava/lang/String;
    ...
    .line 545
    invoke-static {v6}, Lokhttp3/Cache;->readInt(Lc/e;)I
    ...
    .line 579
    invoke-direct {p0, v6}, Lokhttp3/Cache$Entry;->readCertificateList(Lc/e;)Ljava/util/List;
...
.method private readCertificateList(Lc/e;)Ljava/util/List;
    .locals 6
    ...
    .prologue
    .line 661
    invoke-static {p1}, Lokhttp3/Cache;->readInt(Lc/e;)I
    ...
    .line 668
    invoke-interface {p1}, Lc/e;->s()Ljava/lang/String;
    ...
    .line 671
    invoke-virtual {v5}, Lc/c;->g()Ljava/io/InputStream;
...
.method private writeCertList(Lc/d;Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lc/d;->m(J)Lc/d;
...
.method public writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 607
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lc/r;
    ...
    invoke-interface {v2, v4, v5}, Lc/d;->m(J)Lc/d;
    ...
    .line 634
    invoke-interface {v0, v4, v5}, Lc/d;->m(J)Lc/d;
    ...
    invoke-direct {p0, v2, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lc/d;Ljava/util/List;)V
