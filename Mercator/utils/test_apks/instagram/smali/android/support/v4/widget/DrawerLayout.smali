...
.field static final c:Landroid/support/v4/widget/DrawerLayout$c;
...
.field private final k:Landroid/support/v4/widget/af;

.field private final l:Landroid/support/v4/widget/af;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/DrawerLayout$c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/af;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/af$a;)Landroid/support/v4/widget/af;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/af;

    .line 384
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/af;

    invoke-virtual {v2, v4}, Landroid/support/v4/widget/af;->a(I)V

    .line 385
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/af;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/af;->a(F)V

    .line 386
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/DrawerLayout$h;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/af;

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/DrawerLayout$h;->a(Landroid/support/v4/widget/af;)V
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/af;

    .line 389
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/af;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/af;->a(I)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/widget/DrawerLayout$h;->a(Landroid/support/v4/widget/af;)V
    ...
    invoke-static {p0, v1}, Landroid/support/v4/view/ae;->a(Landroid/view/View;Landroid/support/v4/view/a;)V

    .line 400
    const/4 v1, 0x0

    invoke-static {p0, v1}, Landroid/support/v4/view/aq;->a(Landroid/view/ViewGroup;Z)V
    ...
    .line 402
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/DrawerLayout$c;
...
.method private c(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/ae;->c(Landroid/view/View;I)V
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/af;
    ...
    .line 638
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/af;
...
.method a(IILandroid/view/View;)V
    ...
    .line 804
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/af;
...
.method public a(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, p1, v2, v1}, Landroid/support/v4/widget/af;->a(Landroid/view/View;II)Z
...
.method a(Z)V
    ...
    .line 1569
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/af;
    ...
    .line 1572
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/af;
...
.method public computeScroll()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/af;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1344
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/DrawerLayout$c;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/af;
    ...
    .line 1452
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/af;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/af;->d(I)Z
...
.method protected onMeasure(II)V
    ...
    .line 1068
    invoke-static {v10}, Landroid/support/v4/view/ae;->x(Landroid/view/View;)Z
    ...
    .line 1069
    sget-object v11, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/DrawerLayout$c;
    ...
    .line 1084
    invoke-static {v10}, Landroid/support/v4/view/ae;->u(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Landroid/support/v4/view/ae;->f(Landroid/view/View;F)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1505
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/af;
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/ae;->f(Landroid/view/View;F)V
