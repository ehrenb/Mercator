...
.implements Landroid/support/v4/content/j$b;
...
.field d:Landroid/support/v4/content/j;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method a()V
    ...
    .line 255
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/ag$a;->d:Landroid/support/v4/content/j;
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/af$a;->a(ILandroid/os/Bundle;)Landroid/support/v4/content/j;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/ag$a;->d:Landroid/support/v4/content/j;
    ...
    iget-object v2, p0, Landroid/support/v4/app/ag$a;->d:Landroid/support/v4/content/j;
    ...
    invoke-virtual {v0, v1, p0}, Landroid/support/v4/content/j;->a(ILandroid/support/v4/content/j$b;)V

    .line 267
    iget-object v0, p0, Landroid/support/v4/app/ag$a;->d:Landroid/support/v4/content/j;

    invoke-virtual {v0, p0}, Landroid/support/v4/content/j;->a(Landroid/support/v4/content/j$a;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/j;->i()V
...
.method public a(Landroid/support/v4/content/j;)V
    ...
    iget-object v0, v0, Landroid/support/v4/app/ag;->b:Landroid/support/v4/f/k;
    ...
    iget-object v1, v1, Landroid/support/v4/app/ag;->b:Landroid/support/v4/f/k;

    iget v2, p0, Landroid/support/v4/app/ag$a;->a:I

    invoke-virtual {v1, v2, v4}, Landroid/support/v4/f/k;->b(ILjava/lang/Object;)V

    .line 404
    invoke-virtual {p0}, Landroid/support/v4/app/ag$a;->f()V
...
.method public a(Landroid/support/v4/content/j;Ljava/lang/Object;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 444
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/ag$a;->b(Landroid/support/v4/content/j;Ljava/lang/Object;)V

    .line 454
    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/ag$a;->o:Landroid/support/v4/app/ag;

    iget-object v0, v0, Landroid/support/v4/app/ag;->c:Landroid/support/v4/f/k;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/f/k;->c(I)V

    .line 461
    :cond_8
    iget-object v0, p0, Landroid/support/v4/app/ag$a;->o:Landroid/support/v4/app/ag;

    iget-object v0, v0, Landroid/support/v4/app/ag;->h:Landroid/support/v4/app/x;
...
.method public a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2, p3, p4}, Landroid/support/v4/content/j;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method b(Landroid/support/v4/content/j;Ljava/lang/Object;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, v1, Landroid/support/v4/app/ag;->h:Landroid/support/v4/app/x;
    ...
    .line 475
    invoke-virtual {p1, p2}, Landroid/support/v4/content/j;->c(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/af$a;->a(Landroid/support/v4/content/j;Ljava/lang/Object;)V
    :try_end_0
    ...
    iget-object v2, v2, Landroid/support/v4/app/ag;->h:Landroid/support/v4/app/x;
...
.method c()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/ag$a;->b(Landroid/support/v4/content/j;Ljava/lang/Object;)V
...
.method e()V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/content/j;->a(Landroid/support/v4/content/j$b;)V

    .line 326
    iget-object v0, p0, Landroid/support/v4/app/ag$a;->d:Landroid/support/v4/content/j;

    invoke-virtual {v0, p0}, Landroid/support/v4/content/j;->b(Landroid/support/v4/content/j$a;)V

    .line 327
    iget-object v0, p0, Landroid/support/v4/app/ag$a;->d:Landroid/support/v4/content/j;

    invoke-virtual {v0}, Landroid/support/v4/content/j;->m()V
...
.method f()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/ag$a;->d:Landroid/support/v4/content/j;
    ...
    iget-object v3, p0, Landroid/support/v4/app/ag$a;->d:Landroid/support/v4/content/j;

    invoke-interface {v0, v3}, Landroid/support/v4/app/af$a;->a(Landroid/support/v4/content/j;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/j;->o()V
