...
.method protected a(Landroid/support/v7/a/d$a;)V
    .locals 0
...
.method public b()Landroid/support/v7/preference/DialogPreference;
    ...
    .line 174
    invoke-interface {v0, v1}, Landroid/support/v7/preference/DialogPreference$a;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .prologue
    .line 134
    invoke-virtual {p0}, Landroid/support/v7/preference/c;->getActivity()Landroid/support/v4/app/u;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/a/d$a;->a(Ljava/lang/CharSequence;)Landroid/support/v7/a/d$a;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v7/preference/c;->g:Landroid/graphics/drawable/BitmapDrawable;

    invoke-virtual {v1, v2}, Landroid/support/v7/a/d$a;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/a/d$a;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v7/preference/c;->c:Ljava/lang/CharSequence;

    invoke-virtual {v1, v2, p0}, Landroid/support/v7/a/d$a;->a(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/a/d$a;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v7/preference/c;->d:Ljava/lang/CharSequence;

    invoke-virtual {v1, v2, p0}, Landroid/support/v7/a/d$a;->b(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/a/d$a;
    ...
    .line 146
    invoke-virtual {v1, v0}, Landroid/support/v7/a/d$a;->b(Landroid/view/View;)Landroid/support/v7/a/d$a;

    .line 151
    :goto_0
    invoke-virtual {p0, v1}, Landroid/support/v7/preference/c;->a(Landroid/support/v7/a/d$a;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/a/d$a;->b(Ljava/lang/CharSequence;)Landroid/support/v7/a/d$a;
