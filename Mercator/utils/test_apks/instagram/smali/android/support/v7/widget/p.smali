...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroid/support/v7/widget/p;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 57
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/p;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method private a(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p1, p2, v0, p3, p4}, Landroid/support/v7/widget/bj;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bj;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/p;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/bj;->g(II)I

    move-result v1

    invoke-virtual {p0, v1}, Landroid/support/v7/widget/p;->setAnimationStyle(I)V
    ...
    .line 85
    invoke-static {p0}, Landroid/support/v7/widget/p;->a(Landroid/widget/PopupWindow;)V
...
.method private static a(Landroid/widget/PopupWindow;)V
    ...
    .line 131
    new-instance v3, Landroid/support/v7/widget/p$1;

    invoke-direct {v3, v1, p0, v0}, Landroid/support/v7/widget/p$1;-><init>(Ljava/lang/reflect/Field;Landroid/widget/PopupWindow;Landroid/view/ViewTreeObserver$OnScrollChangedListener;)V
...
.method public a(Z)V
    ...
    .line 157
    iput-boolean p1, p0, Landroid/support/v7/widget/p;->b:Z
