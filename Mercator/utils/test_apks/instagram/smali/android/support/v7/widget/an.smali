...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/an;->mLinearInterpolator:Landroid/view/animation/LinearInterpolator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/an;->mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;

    .line 93
    iput v1, p0, Landroid/support/v7/widget/an;->mInterimTargetDx:I

    iput v1, p0, Landroid/support/v7/widget/an;->mInterimTargetDy:I
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/an;->calculateSpeedPerPixel(Landroid/util/DisplayMetrics;)F

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/an;->MILLISECONDS_PER_PX:F
...
.method public calculateDxToMakeVisible(Landroid/view/View;I)I
    ...
    .prologue
    .line 327
    invoke-virtual {p0}, Landroid/support/v7/widget/an;->getLayoutManager()Landroid/support/v7/widget/RecyclerView$h;
    ...
    .line 337
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/an;->calculateDtToFit(IIIII)I
...
.method protected calculateTimeForDeceleration(I)I
    ...
    .prologue
    .line 179
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/an;->calculateTimeForScrolling(I)I
...
.method protected calculateTimeForScrolling(I)I
    ...
    iget v1, p0, Landroid/support/v7/widget/an;->MILLISECONDS_PER_PX:F
...
.method protected getHorizontalSnapPreference()I
    ...
    .line 206
    iget-object v0, p0, Landroid/support/v7/widget/an;->mTargetVector:Landroid/graphics/PointF;
...
.method protected onSeekTargetStep(IILandroid/support/v7/widget/RecyclerView$s;Landroid/support/v7/widget/RecyclerView$r$a;)V
    ...
    .line 127
    invoke-virtual {p0}, Landroid/support/v7/widget/an;->stop()V
    ...
    .line 136
    :cond_1
    iget v0, p0, Landroid/support/v7/widget/an;->mInterimTargetDx:I

    invoke-direct {p0, v0, p1}, Landroid/support/v7/widget/an;->clampApplyScroll(II)I

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/an;->mInterimTargetDx:I

    .line 137
    iget v0, p0, Landroid/support/v7/widget/an;->mInterimTargetDy:I

    invoke-direct {p0, v0, p2}, Landroid/support/v7/widget/an;->clampApplyScroll(II)I

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/an;->mInterimTargetDy:I
    ...
    .line 140
    invoke-virtual {p0, p4}, Landroid/support/v7/widget/an;->updateActionForInterimTarget(Landroid/support/v7/widget/RecyclerView$r$a;)V
...
.method protected onStop()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/an;->mTargetVector:Landroid/graphics/PointF;
...
.method protected onTargetFound(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$s;Landroid/support/v7/widget/RecyclerView$r$a;)V
    ...
    .prologue
    .line 112
    invoke-virtual {p0}, Landroid/support/v7/widget/an;->getHorizontalSnapPreference()I

    move-result v0

    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/an;->calculateDxToMakeVisible(Landroid/view/View;I)I

    move-result v0

    .line 113
    invoke-virtual {p0}, Landroid/support/v7/widget/an;->getVerticalSnapPreference()I

    move-result v1

    invoke-virtual {p0, p1, v1}, Landroid/support/v7/widget/an;->calculateDyToMakeVisible(Landroid/view/View;I)I
    ...
    .line 115
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/an;->calculateTimeForDeceleration(I)I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/an;->mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;
...
.method protected updateActionForInterimTarget(Landroid/support/v7/widget/RecyclerView$r$a;)V
    ...
    .line 232
    invoke-virtual {p0}, Landroid/support/v7/widget/an;->getTargetPosition()I

    move-result v0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/an;->computeScrollVectorForPosition(I)Landroid/graphics/PointF;
    ...
    .line 239
    :cond_1
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/an;->normalize(Landroid/graphics/PointF;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/an;->calculateTimeForScrolling(I)I

    move-result v0

    .line 248
    iget v1, p0, Landroid/support/v7/widget/an;->mInterimTargetDx:I
    ...
    iget v2, p0, Landroid/support/v7/widget/an;->mInterimTargetDy:I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/an;->mLinearInterpolator:Landroid/view/animation/LinearInterpolator;
