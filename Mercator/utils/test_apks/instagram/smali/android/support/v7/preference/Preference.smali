...
.method private a(Landroid/content/SharedPreferences$Editor;)V
    ...
    .line 1324
    invoke-static {}, Landroid/support/v4/content/n$a;->a()Landroid/support/v4/content/n$a;

    move-result-object v0

    invoke-virtual {v0, p1}, Landroid/support/v4/content/n$a;->a(Landroid/content/SharedPreferences$Editor;)V
...
.method private b()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/preference/Preference;->F()Landroid/content/SharedPreferences;
...
.method private b(Landroid/support/v7/preference/Preference;)V
    ...
    .line 1164
    invoke-virtual {p0}, Landroid/support/v7/preference/Preference;->i()Z
...
.method public D()V
    ...
    invoke-interface {v0, p0}, Landroid/support/v7/preference/Preference$c;->onPreferenceClick(Landroid/support/v7/preference/Preference;)Z
    ...
    .line 958
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/preference/Preference;->I()Landroid/support/v7/preference/g;
    ...
    invoke-interface {v0, p0}, Landroid/support/v7/preference/g$c;->onPreferenceTreeClick(Landroid/support/v7/preference/Preference;)Z
    ...
    .line 968
    invoke-virtual {p0}, Landroid/support/v7/preference/Preference;->E()Landroid/content/Context;
...
.method public I()Landroid/support/v7/preference/g;
    .locals 1
...
.method K()Ljava/lang/StringBuilder;
    ...
    .line 1572
    invoke-virtual {p0}, Landroid/support/v7/preference/Preference;->u()Ljava/lang/CharSequence;
    ...
    .line 1576
    :cond_0
    invoke-virtual {p0}, Landroid/support/v7/preference/Preference;->l()Ljava/lang/CharSequence;
...
.method public a(Landroid/support/v7/preference/h;)V
    ...
    .line 478
    iget-object v0, p1, Landroid/support/v7/preference/h;->itemView:Landroid/view/View;
    ...
    .line 526
    :goto_4
    invoke-virtual {p0}, Landroid/support/v7/preference/Preference;->w()Z

    move-result v0

    .line 527
    iget-object v1, p1, Landroid/support/v7/preference/h;->itemView:Landroid/view/View;
...
.method b(Landroid/os/Bundle;)V
    ...
    .line 1612
    invoke-virtual {p0}, Landroid/support/v7/preference/Preference;->j()Landroid/os/Parcelable;
...
.method protected b(Z)Z
    ...
    :cond_0
    invoke-virtual {p0, v0}, Landroid/support/v7/preference/Preference;->c(Z)Z
...
.method protected d(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/preference/Preference;->e(Ljava/lang/String;)Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    .prologue
    .line 1556
    invoke-virtual {p0}, Landroid/support/v7/preference/Preference;->K()Ljava/lang/StringBuilder;
