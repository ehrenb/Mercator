...
# static fields
.field private static d:Landroid/support/v7/a/q;
...
.method static a()Landroid/support/v7/a/q;
    .locals 1

    .prologue
    .line 31
    sget-object v0, Landroid/support/v7/a/q;->d:Landroid/support/v7/a/q;
    ...
    invoke-direct {v0}, Landroid/support/v7/a/q;-><init>()V

    sput-object v0, Landroid/support/v7/a/q;->d:Landroid/support/v7/a/q;
...
.method public a(JDD)V
    ...
    iput v2, p0, Landroid/support/v7/a/q;->c:I

    .line 115
    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/a/q;->a:J

    .line 116
    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/a/q;->b:J
    ...
    iput-wide v6, p0, Landroid/support/v7/a/q;->a:J
    ...
    .line 130
    iget-wide v2, p0, Landroid/support/v7/a/q;->b:J

    cmp-long v2, v2, p1

    if-gez v2, :cond_2

    iget-wide v2, p0, Landroid/support/v7/a/q;->a:J
