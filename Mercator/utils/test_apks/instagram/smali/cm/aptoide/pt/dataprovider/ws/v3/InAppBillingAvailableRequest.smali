.class public Lcm/aptoide/pt/dataprovider/ws/v3/InAppBillingAvailableRequest;
.super Lcm/aptoide/pt/dataprovider/ws/v3/V3;
.source "InAppBillingAvailableRequest.java"
...
.method public static of(ILjava/lang/String;Ljava/lang/String;)Lcm/aptoide/pt/dataprovider/ws/v3/InAppBillingAvailableRequest;
    .locals 3
    ...
    .line 27
    new-instance v1, Lcm/aptoide/pt/dataprovider/ws/v3/InAppBillingAvailableRequest;

    const-string v2, "https://webservices.aptoide.com/webservices/3/"

    invoke-direct {v1, v2, v0}, Lcm/aptoide/pt/dataprovider/ws/v3/InAppBillingAvailableRequest;-><init>(Ljava/lang/String;Lcm/aptoide/pt/dataprovider/ws/v3/BaseBody;)V
...
.method protected loadDataFromNetwork(Lcm/aptoide/pt/dataprovider/ws/v3/V3$Interfaces;Z)Lrx/d;
    ...
    .prologue
    .line 33
    iget-object v0, p0, Lcm/aptoide/pt/dataprovider/ws/v3/InAppBillingAvailableRequest;->map:Lcm/aptoide/pt/dataprovider/ws/v3/BaseBody;

    invoke-interface {p1, v0}, Lcm/aptoide/pt/dataprovider/ws/v3/V3$Interfaces;->getInAppBillingAvailable(Lcm/aptoide/pt/dataprovider/ws/v3/BaseBody;)Lrx/d;
...
.method protected bridge synthetic loadDataFromNetwork(Ljava/lang/Object;Z)Lrx/d;
    ...
    invoke-virtual {p0, p1, p2}, Lcm/aptoide/pt/dataprovider/ws/v3/InAppBillingAvailableRequest;->loadDataFromNetwork(Lcm/aptoide/pt/dataprovider/ws/v3/V3$Interfaces;Z)Lrx/d;
