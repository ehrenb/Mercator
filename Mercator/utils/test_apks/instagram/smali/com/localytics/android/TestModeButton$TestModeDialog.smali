...
.method private adjustLayout()V
    ...
    invoke-virtual {v0}, Lcom/localytics/android/TestModeButton;->getActivity()Landroid/app/Activity;
    ...
    .line 314
    iget-object v1, p0, Lcom/localytics/android/TestModeButton$TestModeDialog;->this$0:Lcom/localytics/android/TestModeButton;

    # getter for: Lcom/localytics/android/TestModeButton;->mEnterAnimatable:Ljava/util/concurrent/atomic/AtomicBoolean;
    invoke-static {v1}, Lcom/localytics/android/TestModeButton;->access$300(Lcom/localytics/android/TestModeButton;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 316
    iget-object v1, p0, Lcom/localytics/android/TestModeButton$TestModeDialog;->mDialogLayout:Landroid/widget/RelativeLayout;

    iget-object v2, p0, Lcom/localytics/android/TestModeButton$TestModeDialog;->mAnimIn:Landroid/view/animation/TranslateAnimation;
...
.method private setupViews()V
    ...
    invoke-direct {v0, p0, v1, v2}, Lcom/localytics/android/TestModeButton$TestModeDialog$Button;-><init>(Lcom/localytics/android/TestModeButton$TestModeDialog;Landroid/content/Context;Landroid/util/AttributeSet;)V

    .line 244
    new-instance v1, Lcom/localytics/android/TestModeButton$TestModeDialog$1;

    invoke-direct {v1, p0}, Lcom/localytics/android/TestModeButton$TestModeDialog$1;-><init>(Lcom/localytics/android/TestModeButton$TestModeDialog;)V

    invoke-virtual {v0, v1}, Lcom/localytics/android/TestModeButton$TestModeDialog$Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V
