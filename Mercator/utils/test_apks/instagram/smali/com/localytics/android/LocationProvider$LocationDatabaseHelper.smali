...
.method protected migrateV2ToV3(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 292
    const-string v0, "CREATE TABLE %s (%s INTEGER PRIMARY KEY,%s TEXT NOT NULL UNIQUE,%s TEXT,%s INTEGER NOT NULL,%s INTEGER NOT NULL,%s INTEGER NOT NULL,%s INTEGER NOT NULL DEFAULT 0,%s INTEGER NOT NULL DEFAULT 0,%s INTEGER NOT NULL DEFAULT 0,%s INTEGER NOT NULL DEFAULT 0,%s INTEGER NOT NULL DEFAULT 1,%s INTEGER NOT NULL DEFAULT 0);"
    ...
    const-string v3, "enter_analytics_enabled"

    aput-object v3, v1, v2

    const/16 v2, 0x8

    const-string v3, "exit_analytics_enabled"

    aput-object v3, v1, v2

    const/16 v2, 0x9

    const-string v3, "entered_time"

    aput-object v3, v1, v2

    const/16 v2, 0xa

    const-string v3, "exited_time"
    ...
    .line 320
    const-string v0, "CREATE TABLE %s (%s INTEGER PRIMARY KEY AUTOINCREMENT,%s INTEGER REFERENCES %s(%s) ON DELETE CASCADE,%s TEXT NOT NULL,%s TEXT NOT NULL);"

    const/4 v1, 0x7

    new-array v1, v1, [Ljava/lang/Object;

    const-string v2, "geofences_attributes"
    ...
    .line 334
    const-string v0, "CREATE TABLE %s (%s INTEGER,%s INTEGER);"
