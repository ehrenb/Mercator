...
.method constructor <init>(Lcom/localytics/android/MarketingHandler;Ljava/lang/Boolean;Ljava/util/Map;Ljava/util/Map;)V
    ...
    iput-object p2, p0, Lcom/localytics/android/MarketingHandler$10;->val$successful:Ljava/lang/Boolean;

    iput-object p3, p0, Lcom/localytics/android/MarketingHandler$10;->val$marketingMap:Ljava/util/Map;

    iput-object p4, p0, Lcom/localytics/android/MarketingHandler$10;->val$config:Ljava/util/Map;
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/localytics/android/MarketingHandler$10;->val$successful:Ljava/lang/Boolean;

    invoke-virtual {v1}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v1

    iget-object v2, p0, Lcom/localytics/android/MarketingHandler$10;->val$marketingMap:Ljava/util/Map;

    iget-object v3, p0, Lcom/localytics/android/MarketingHandler$10;->val$config:Ljava/util/Map;

    invoke-virtual {v0, v1, v2, v3}, Lcom/localytics/android/InboxManager;->_processMarketingObject(ZLjava/util/Map;Ljava/util/Map;)V
