...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/b;->b:Landroid/content/Context;
...
.method static a(Landroid/os/Bundle;)Z
    ...
    invoke-static {p0, v1}, Lcom/google/android/gms/gcm/b;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/gcm/b;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
...
.method private b(Ljava/lang/String;)I
    ...
    iget-object v2, p0, Lcom/google/android/gms/gcm/b;->b:Landroid/content/Context;
...
.method private b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_2
    invoke-direct {p0, v0}, Lcom/google/android/gms/gcm/b;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private d(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    invoke-direct {p0, p1, v1}, Lcom/google/android/gms/gcm/b;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    const-string v2, "gcm.n.icon"

    invoke-static {p1, v2}, Lcom/google/android/gms/gcm/b;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-direct {p0, v2}, Lcom/google/android/gms/gcm/b;->b(Ljava/lang/String;)I

    move-result v2

    const-string v3, "gcm.n.color"

    invoke-static {p1, v3}, Lcom/google/android/gms/gcm/b;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string v4, "gcm.n.sound2"

    invoke-static {p1, v4}, Lcom/google/android/gms/gcm/b;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-direct {p0, v4}, Lcom/google/android/gms/gcm/b;->c(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v4

    invoke-direct {p0, p1}, Lcom/google/android/gms/gcm/b;->e(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v5

    new-instance v6, Landroid/support/v4/app/am$d;

    iget-object v7, p0, Lcom/google/android/gms/gcm/b;->b:Landroid/content/Context;

    invoke-direct {v6, v7}, Landroid/support/v4/app/am$d;-><init>(Landroid/content/Context;)V

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Landroid/support/v4/app/am$d;->b(Z)Landroid/support/v4/app/am$d;

    move-result-object v6

    invoke-virtual {v6, v2}, Landroid/support/v4/app/am$d;->a(I)Landroid/support/v4/app/am$d;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/app/am$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/am$d;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/app/am$d;->c(I)Landroid/support/v4/app/am$d;

    :cond_1
    if-eqz v4, :cond_2

    invoke-virtual {v2, v4}, Landroid/support/v4/app/am$d;->a(Landroid/net/Uri;)Landroid/support/v4/app/am$d;

    :cond_2
    if-eqz v5, :cond_3

    invoke-virtual {v2, v5}, Landroid/support/v4/app/am$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/am$d;
...
.method private e(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {v0}, Lcom/google/android/gms/gcm/a;->zzac(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lcom/google/android/gms/gcm/b;->a()I
...
.method c(Landroid/os/Bundle;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1}, Lcom/google/android/gms/gcm/b;->d(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    invoke-direct {p0, v1, v0}, Lcom/google/android/gms/gcm/b;->a(Ljava/lang/String;Landroid/app/Notification;)V
    :try_end_0
    .catch Lcom/google/android/gms/gcm/b$a; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/gcm/b$a;->getMessage()Ljava/lang/String;
