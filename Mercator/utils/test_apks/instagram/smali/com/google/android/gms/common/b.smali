...
.method public a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0, p3}, Lcom/google/android/gms/common/internal/o;->a(Landroid/app/Activity;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/o;

    move-result-object v0

    invoke-virtual {p0, p1, p2, v0, p4}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/o;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0}, Lcom/google/android/gms/common/internal/n;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method a(Landroid/content/Context;ILcom/google/android/gms/common/internal/o;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    :cond_2
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/n;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/n;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/n;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/internal/nq$a;)Lcom/google/android/gms/internal/nq;
    .locals 2
    ...
    invoke-direct {v0, p2}, Lcom/google/android/gms/internal/nq;-><init>(Lcom/google/android/gms/internal/nq$a;)V

    invoke-virtual {p1, v0, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-virtual {v0, p1}, Lcom/google/android/gms/internal/nq;->a(Landroid/content/Context;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/internal/nq$a;->a()V
...
.method a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {v1, v0, p3}, Lcom/google/android/gms/common/c;->show(Landroid/support/v4/app/y;Ljava/lang/String;)V
...
.method a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/n;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/n;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/am$d;-><init>(Landroid/content/Context;)V

    const v4, 0x108008a

    invoke-virtual {v3, v4}, Landroid/support/v4/app/am$d;->a(I)Landroid/support/v4/app/am$d;
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/app/am$d;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/am$d;
    ...
    invoke-virtual {v2, v4, v5}, Landroid/support/v4/app/am$d;->a(J)Landroid/support/v4/app/am$d;

    move-result-object v2

    invoke-virtual {v2, v6}, Landroid/support/v4/app/am$d;->b(Z)Landroid/support/v4/app/am$d;

    move-result-object v2

    invoke-virtual {v2, p4}, Landroid/support/v4/app/am$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/am$d;

    move-result-object v2

    invoke-virtual {v2, v0}, Landroid/support/v4/app/am$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/am$d;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v4/app/am$d;->c(Z)Landroid/support/v4/app/am$d;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/app/am$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/am$c;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/support/v4/app/am$d;->a(Landroid/support/v4/app/am$q;)Landroid/support/v4/app/am$d;
    ...
    sget-object v1, Lcom/google/android/gms/common/h;->xf:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)V
    ...
    invoke-virtual {p0, p1, v1, v2, v0}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
...
.method public a(Landroid/app/Activity;Lcom/google/android/gms/internal/nu;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 2
    ...
    invoke-static {p2, v0, p4}, Lcom/google/android/gms/common/internal/o;->a(Lcom/google/android/gms/internal/nu;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/o;

    move-result-object v0

    invoke-virtual {p0, p1, p3, v0, p5}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/o;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
